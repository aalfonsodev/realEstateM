...
//create instance and save to database, create everything and link it together
...
const updateProperty = async (req, res) => {
    try {
        ...
        await Property.findByIdAndUpdate( {_id: id}, {title, description, propertyType, price, location, photo: photoUrl.url || photo});
...
const deleteProperty = async (req, res) => {
    try {
      ...
      await propertyToDelete.creator.allProperties.pull(propertyToDelete._id);
